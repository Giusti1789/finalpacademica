...
<body class="py-5">
    <main class="container">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-10">
                    <form class="row g-3" method="POST" action="../guardar/sumarPresupuesto.php">
                        ...
                        <div class="col-md-8">
                            ...
                            <input readonly type="text" class="form-control" id="txt_nombre" name="txt_nombre" 
                            value="<?php echo $carrera['nombre'] ?>">

                            <label for="monto" class="form-label">Monto a Agregar</label>
                            <input type="number" class="form-control" id="txt_agregar" name="txt_agregar">
                            <br>
